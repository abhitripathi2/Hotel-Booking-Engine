...
import com.codingShuttle.projects.HotelManagement.App.entity.HotelMinPrice;
...
public interface HotelMinPriceRepository extends JpaRepository<HotelMinPrice, Long> {
    ...
    @Query("""
            SELECT new com.codingShuttle.projects.HotelManagement.App.dto.HotelPriceDto(i.hotel, AVG(i.price))
